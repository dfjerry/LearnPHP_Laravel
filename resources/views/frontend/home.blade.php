            ...
            <div class="row featured__filter">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{$featured->getImage()}}">
                                ...
                                @foreach($latests1 as $latest1)
                                    <a href="{{$latest1->getProductUrl()}}" class="latest-product__item">
                                        ...
                                        <div class="latest-product__item__text">
                                            <h6>{{$latest1->__get("product_name")}}</h6>
                                            <span>{{$latest1->getPrice()}}</span>
                                        </div>
                                    </a>
                                    @endforeach
                            </div>
                            <div class="latest-prdouct__slider__item">
                                @foreach($latests2 as $latest2)
                                    <a href="{{$latest2->getProductUrl()}}" class="latest-product__item">
                                        ...
                                        <div class="latest-product__item__text">
                                            <h6>{{$latest2->__get("product_name")}}</h6>
                                            <span>{{$latest2->getPrice()}}</span>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
